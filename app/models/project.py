...
Used to persist project state on the server side to avoid frontend passing large amounts of data between interfaces
"""
...
class ProjectManager:
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, returns None if not found
        """
