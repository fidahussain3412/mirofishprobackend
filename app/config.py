...
Unified configuration loading from project root .env file
"""
...
class Config:
    ...
    # JSON Configuration - Disable ASCII escaping to show Chinese characters directly (not \uXXXX format)
    JSON_AS_ASCII = False
